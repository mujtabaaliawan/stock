...
from category.test.factories import TraderFactory
import json
...
class TestCategory(APITransactionTestCase):
    ...
    def test_post_dataupdater(self):
        ...
        data = [
            ...
            {"category": "AUTOMOBILE ASSEMBLER", "company": "Honda Atlas Cars (Pak) Ltd.", "ldcp": 150.08,
             ...
             "date_time": "2022-12-08 11:59:05"},
            {"category": "AUTOMOBILE ASSEMBLER", "company": "Pak Suzuki Motors Co Ltd.", "ldcp": 148.22, "open": 148.9,
             "high": 149.0, "low": 146.51, "current": 147.0, "change": -1.22, "volume": 42769.0,
             "date_time": "2022-12-08 11:59:05"},
            {"category": "AUTOMOBILE ASSEMBLER", "company": "Al-Ghazi Tractors Limited.", "ldcp": 342.0, "open": 347.9,
             "high": 349.99, "low": 347.9, "current": 349.99, "change": 7.99, "volume": 500.0,
             "date_time": "2022-12-08 11:59:05"}
        ]
    ...
    def test_get_category_list(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data[0].get('name'), data[0]["category"])
