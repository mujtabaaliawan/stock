...
from price.factories import TraderFactory
import json
...
class TestPrice(APITestCase):
    ...
    def test_get_latest_prices(self):
        ...
        self.assertEqual(market_data[0]["category_name"], data[0]["category"])
        self.assertEqual(market_data[0]["company_name"], data[0]["company"])
        ...
        self.assertEqual(market_data[0]["date_time"], data[0]["date_time"].replace(' ', 'T'))

        self.assertEqual(market_data[1]["category_name"], data[1]["category"])
        self.assertEqual(market_data[1]["company_name"], data[1]["company"])
        ...
        self.assertEqual(market_data[1]["date_time"], data[1]["date_time"].replace(' ', 'T'))
